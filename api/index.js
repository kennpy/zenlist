        ...
        try{
            ...
            //fs.readFile(filepath + "/tasks.txt", 'utf8', (err, data) => {
                fs.readFile("/tmp" + "/tasks.txt", 'utf8', (err, data) => {
                    if (err) {
                        const defaultTask = '{"test":[false,"978a8058-6376-4c80-86a1-9697be3b4509",0]}{"test":[false,"1a1326f2-c60d-4df1-ba92-65352b49c64c",0]}';
                        fs.appendFile("/tmp/tasks.txt", defaultTask, (newErr) => console.log("error :",newErr));
                        fs.readFile("/tmp" + "/tasks.txt", 'utf8', (updatedErr, updatedData) => {
                            if (updatedErr) {
